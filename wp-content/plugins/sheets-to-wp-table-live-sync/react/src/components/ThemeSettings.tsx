...
import { swapIcon, lockWhite, lockBTN, hintIcon, Cross, editOnhoverDot, Backbtn, lockpro } from '../icons';
...
const ThemeSettings = ({ tableSettings, setTableSettings }) => {
	...
	const [activeThemeErrorModal, setActiveThemeErrorModal] = useState(false);
	...
	const isThemeNameUsed = (themeName) => {
		...
		return Object.keys(tableSettings.table_settings.import_styles_theme_colors).some(
			(existingThemeName) => existingThemeName.toLowerCase() === normalizedThemeName
		);
	};
	...
	const handleEditTheme = (themeName) => {
		const themeColors = tableSettings.table_settings.import_styles_theme_colors[themeName];
		setCustomTheme({
			name: themeName,
	...
	const handleConfirmDeleteTheme = () => {
		const { [themeToDelete]: _, ...newThemes } = tableSettings.table_settings.import_styles_theme_colors;
		setTableSettings(prevSettings => ({
			...prevSettings,
			table_settings: {
				...prevSettings.table_settings,
	...
	const handleSaveEditedTheme = () => {
		...
		setTableSettings((prevSettings) => {
			const updatedThemes = { ...prevSettings.table_settings.import_styles_theme_colors };
			...
			{customThemeModal && (
				<Modal>
					<div className="import-style-modal-wrap modal-content theme-create-edit">
						<div className="cross_sign left-back" onClick={handleClosePopup}>
							{Cross}
						</div>
						<div className="import-style-modal" ref={customThemeRef}>

							<h2 className='heading-title'><span className='back-btn' onClick={handleClosePopup}>{Backbtn}</span> {isEditing ? 'Edit Custom Theme' : 'Create Custom Theme'}</h2>
							<div className="custom-theme-field-group name-field">

								<label htmlFor="custom-theme-name-field">{getStrings('theme-name')}</label>
								<input
								...
								{!isEditing && themeNameError && (
									<div className="error-message">Name already used, please use another name for theme</div>
								)}

								{emptyNameError && (
									<div className="error-message">Name field can not be empty</div>
								)}

							</div>

							<h4 className='title-divider'>{getStrings('theme-colors')}</h4>
							...
							<div className="theme-colors">
								<div className="theme-design-modal">
									...
									<div className="theme-colors__palette">
										...
										<div className="theme-colors__scheme">
											<input
												...
												value={customTheme.headerBGColor || '#ffffff'}
												onChange={handleCustomThemeChange}
											/>
											<label htmlFor='color-picker-headerBGColor'>{getStrings('bg-color')}</label>
										</div>
										<div className="theme-colors__scheme">
											<input
												...
												value={customTheme.headerTextColor || '#000000'}
												onChange={handleCustomThemeChange}
											/>
											<label htmlFor='color-picker-headerTextColor'>{getStrings('txt-color')}</label>
										</div>
									</div>
									...
									<div className="theme-colors__palette">
										...
										<div className="theme-colors__scheme">
											<input
												...
												value={customTheme.borderColor || '#000000'}
												onChange={handleCustomThemeChange}
											/>
											<label htmlFor='color-picker-borderColor'>{getStrings('inside-border-color')}</label>
										</div>
										<div className="theme-colors__scheme">
											<input
												...
												value={customTheme.outsideborderColor || '#ffffff'}
												onChange={handleCustomThemeChange}
											/>
											<label htmlFor='color-picker-outside-outsideborderColor'>Outside border</label>
										</div>
									...
									<div className="theme-colors__palette">
										...
										<div className="theme-colors__scheme">
											<input
												...
												value={customTheme.bodyTextColorCol_1 || '#333333'}
												onChange={handleCustomThemeChange}
											/>
											<label htmlFor='color-picker-bodyTextColorCol_1'>{getStrings('first-cl-txt-color')}</label>
										</div>
										...
										<div className="theme-colors__scheme">
											<input
												...
												value={customTheme.bodyTextColorColRest || '#6b6b6b'}
												onChange={handleCustomThemeChange}
											/>
											<label htmlFor='color-picker-bodyTextColorColRest'>{getStrings('rest-txt-color')}</label>
										</div>
									...
									<div className="theme-colors__palette body-colors">
										...
										{customTheme.activeRowColumnMode === false && (
											<div className="theme-colors__scheme">
												<input
													...
													value={customTheme.bodyBGColor}
													onChange={handleCustomThemeChange}
												/>
												<label htmlFor='color-picker-bodyBGColor'>{getStrings('table-bg-color')}</label>
											</div>
										)}

										{/* Toggle for active row and column  */}
										<div className="edit-form-group active-rowcol-style">
											<label className={`${!isProActive() ? `swptls-pro-settings` : ``}`} htmlFor="active-rowcol-style">
												<div className="toggle-switch">
													<input
														type="hidden"
														name="activeRowColumnMode"
														value={customTheme.activeRowColumnMode ? 'enabled' : 'disabled'}
													/>
													<input
														type="checkbox"
														id="active-rowcol-style"
														name="activeRowColumnMode"
														checked={customTheme.activeRowColumnMode}
														onChange={handleCustomThemeChange}
													/>
													<div className="slider round"></div>
												</div>
												{getStrings('enable-row-column-ordering')}{' '}
												<Tooltip content={getStrings('tooltip-50')} />{' '}
											</label>
										</div>


										{customTheme.activeRowColumnMode === true && (
											<>
												{/* Selection Row and Column  */}
												<div className={`edit-form-group`}>
													<h4>
														<span className={`${!isProActive() ? ` swptls-pro-settings` : ``}`}>
															{getStrings('select-coloring')}{' '}
															<Tooltip content={getStrings('tooltip-51')} />{' '}
														</span>
													...
													<div className={`utility-checkbox-wrapper${!isProActive() ? ` swptls-pro-settings` : ``}`}>
														...
														<label
															className={`utility-checkboxees${customTheme.activeRowColor ? ' active' : ''}`}
														...
														>
															<input
																...
																name="activeRowColor"
																checked={customTheme.activeRowColor}
																onChange={handleCustomThemeChange}
															/>
															<span>
																{getStrings('active-row-colors')}{' '}
																<Tooltip content={getStrings('tooltip-53')} />
															</span>
															<div
																className={`control__indicator${customTheme.activeRowColor ? ' active' : ''}`}
															></div>
														</label>

														<label
															className={`utility-checkboxees${customTheme.activeColumnColor ? ' active' : ''}`}
														...
														>
															<input
																...
																checked={customTheme.activeColumnColor}
																onChange={handleCustomThemeChange}
															/>
															<span>
																{getStrings('active-column-colors')}{' '}
																<Tooltip content={getStrings('tooltip-52')} />
															</span>
															<div
																className={`control__indicator${customTheme.activeColumnColor ? ' active' : ''}`}
															></div>
														</label>
												...
												<div className="column-row-selection">
													{/* Column Mode  */}
													{customTheme.activeColumnColor === true && (
														<div className="column-mode-parent">
															<div className="theme-colors__scheme">
																<input
																	...
																	value={customTheme.bodyBGColorEven}
																	onChange={handleCustomThemeChange}
																/>
																<label htmlFor='color-picker-column-bodyBGColorEven'>{getStrings('even-column-color')}</label>
															</div>
															<div className="theme-colors__scheme">
																<input
																	...
																	value={customTheme.bodyBGColorOdd}
																	onChange={handleCustomThemeChange}
																/>
																<label htmlFor='color-picker-column-bodyBGColorOdd'>{getStrings('odd-column-color')}</label>
															</div>
														</div>
													)}
													...
													{customTheme.activeRowColor === true && (
														<div className="row-mode-parent">
															<div className="theme-colors__scheme">
																<input
																	...
																	onChange={handleCustomThemeChange}
																/>
																<label htmlFor='color-picker-bodyBGColorEven'>{getStrings('even-row-color')}</label>
															</div>
															<div className="theme-colors__scheme">
																<input
																	className='color-picker bodyBGColorOdd'
																	...
																	onChange={handleCustomThemeChange}
																/>
																<label htmlFor='color-picker-bodyBGColorOdd'>{getStrings('odd-row-color')}</label>
															</div>
														</div>
													)}
									...
									<div className="theme-colors__palette hover-mode-customization">
										...
										<div className={`edit-form-group`}>
											...
											<div className={`utility-checkbox-wrapper${!isProActive() ? ` swptls-pro-settings` : ``}`}>
												...
												<label
													className={`utility-checkboxees${customTheme.hoverModeNone ? ' active' : ''}`}
												...
												>
													<input
														...
														id='hover_mode_none'
														name="hoverModeNone"
														checked={customTheme.hoverModeNone}
														onChange={handleCustomHovermodeChange}
													/>
													<span>
														{getStrings('none')}
													</span>
													<div
														className={`control__indicator${customTheme.hoverModeNone ? ' active' : ''}`}
													></div>
												</label>

												<label
													className={`utility-checkboxees${customTheme.hoverModeRow ? ' active' : ''}`}
												...
												>
													<input
														...
														id='hover_mode_row'
														name="hoverModeRow"
														checked={customTheme.hoverModeRow}
														onChange={handleCustomHovermodeChange}
													/>
													<span>
														{getStrings('row-wise')}
													...
													<div
														className={`control__indicator${customTheme.hoverModeRow ? ' active' : ''}`}
													></div>
												</label>

												<label
													className={`utility-checkboxees${customTheme.hoverModeColumn ? ' active' : ''}`}
												...
												>
													<input
														...
														checked={customTheme.hoverModeColumn}
														onChange={handleCustomHovermodeChange}
													/>
													<span>
														{getStrings('col-wise')}
													...
													<div
														className={`control__indicator${customTheme.hoverModeColumn ? ' active' : ''}`}
													></div>
												</label>
										...
										<div className="theme-colors__scheme">
											<input
												...
												value={customTheme.hoverBGColor}
												onChange={handleCustomThemeChange}
											/>
											<label htmlFor='color-picker-hoverBGColor'>{getStrings('hover-color')}</label>
										</div>
										...
										<div className="theme-colors__scheme">
											<input
												...
												value={customTheme.hoverTextColor}
												onChange={handleCustomThemeChange}
											/>
											<label htmlFor='color-picker-hoverTextColor'>{getStrings('hover-text-color')}</label>
										</div>
										{/* )} */}
								...
								<div className="action-buttons">
									<button className="swptls-button cancel-button" onClick={handleClosePopup}>
										{getStrings('Cancel')}
									</button>
									<button
										className={`swptls-button confirm-button ${themeNameError ? 'name-erros' : ''}`}
										onClick={isEditing ? handleSaveEditedTheme : handleAddCustomTheme}
									// disabled={!customTheme.name}
									>
										{isEditing ? getStrings('update-changes') : getStrings('add-theme')}
									</button>
								</div>
			...
			{activeThemeErrorModal && (
				<Modal>
					<div className="import-style-modal-wrap modal-content theme-delete-warning-modal">
						<div className="cross_sign" onClick={handleClosePopup}>
							{Cross}
						</div>
						<div className="import-style-modal delete-modal">
							...
							<div className="action-btn">
								<button className='delete-warning' onClick={handleCloseActiveThemeErrorModal}>{getStrings('merge-confirm')}</button>
							</div>
						</div>
					</div>
				</Modal>
			...
			{deleteConfirmationModal && (
				<Modal>
					<div className="import-style-modal-wrap modal-content theme-delete-warning-modal">
						...
						<div className="import-style-modal delete-modal">
							<h3>{getStrings('confirmation-theme-delete')}</h3>
							<p>{getStrings('confirmation-theme-delete-notice')}</p>

							<div className="action-btn">
								<button className='delete-cancle' onClick={handleCloseDeleteConfirmationModal}>{getStrings('Cancel')}</button>
								<button className='delete-confirm' onClick={handleConfirmDeleteTheme}>{getStrings('yes-delete')}</button>
							</div>
						</div>
					</div>
				</Modal>
			...
			<div className="edit-table-customization-wrap">
				<div className="edit-form-group">
					...
					<div className="table-customization-theme-wrapper">
						...
						<div className={`table-customization-theme ${tableSettings
							?.table_settings
							?.import_styles ? 'active_sheetstyle' : 'disable_sheetstyle'
							}`}
						>
							<button
								className={`single-theme ${tableSettings
									?.table_settings
									?.table_style ===
									'default-style'
									? ' active'
								...
								<div className="text">
									<div className="top">
										<div className="label">
											...
											<div className="label-title">{getStrings('Simple')}</div>
										</div>
									</div>
								</div>
							</button>
							...
							>
								...
								<div className="text">
									<div className="top">
										<div className="label">
											<div className="radio-field"></div>
											<div className="label-title">{getStrings('Dark-Table')}</div>
										</div>
									</div>
								</div>
							</button>
							...
							<button
								className={`single-theme${!isProActive() ? ` swptls-pro-theme` : ``} ${tableSettings
									?.table_settings
									?.table_style ===
									'style-6'
									? 'active'
								...
								onMouseEnter={() => handleMouseEnter('style-6')}
							...
							>
								...
								<div className="text">
									<div className="top">
										<div className="label">
											<div className="radio-field"></div>
											<div className="label-title">{getStrings('minimal-simple-style')}</div>
										</div>
									</div>
									<div className="bottom">
										{!isProActive() && (<span className="theme-pro-tags">{lockpro}{` `}{getStrings('pro')}</span>)}
										<span className="theme-new-tags">{getStrings('new')}</span>
									</div>
								</div>
								{isHovered === 'style-6' && !isProActive() && (
									<div className='btn-pro-lock theme-lock-blur'>{lockBTN}</div>
								)}
							...
							<button
								...
								onMouseEnter={() => handleMouseEnter('style-2')}
								onMouseLeave={handleMouseLeave}
							...
							>
								...
								<div className="text">
									<div className="top">
										<div className="label">
											<div className="radio-field"></div>
											<div className="label-title">{getStrings('minimal-Table')}</div>
										</div>
									</div>

									<div className="bottom">
										{!isProActive() && (<span className="theme-pro-tags single-pro">{lockpro}{` `}{getStrings('pro')}</span>)}
									</div>

								</div>
								{isHovered === 'style-2' && !isProActive() && (
									<div className='btn-pro-lock theme-lock-blur'>{lockBTN}</div>
								)}
							...
							<button
								...
								onMouseEnter={() => handleMouseEnter('style-3')}
								onMouseLeave={handleMouseLeave}
							...
							>
								...
								<div className="text">
									<div className="top">
										<div className="label">
											<div className="radio-field"></div>
											<div className="label-title">{getStrings('minimal-elegant-style')}</div>
										</div>
									</div>
									<div className="bottom">
										{!isProActive() && (<span className="theme-pro-tags single-pro">{lockpro}{` `}{getStrings('pro')}</span>)}
							...
							<button
								...
								onMouseEnter={() => handleMouseEnter('style-5')}
								onMouseLeave={handleMouseLeave}
							...
							>
								...
								<div className="text">
									<div className="top">
										<div className="label">
											<div className="radio-field"></div>
											<div className="label-title">{getStrings('Uppercase-heading')}</div>
										</div>
									</div>
									<div className="bottom">
										{!isProActive() && (<span className="theme-pro-tags single-pro">{lockpro}{` `}{getStrings('pro')}</span>)}
							...
							<button
								...
								onMouseEnter={() => handleMouseEnter('style-8')}
								onMouseLeave={handleMouseLeave}
							...
							>
								...
								<div className="text">
									<div className="top">
										<div className="label">
											<div className="radio-field"></div>
											<div className="label-title">{getStrings('uppercase-elegant-theme')}</div>
										</div>
									</div>
									<div className="bottom">
										{!isProActive() && (<span className="theme-pro-tags">{lockpro}{` `}{getStrings('pro')}</span>)}
							...
							<button
								...
								onMouseEnter={() => handleMouseEnter('style-1')}
								onMouseLeave={handleMouseLeave}
							...
							>
								...
								<div className="text">
									<div className="top">
										<div className="label">
											<div className="radio-field"></div>
											<div className="label-title">{getStrings('vertical-style')}</div>
										</div>
									</div>
									<div className="bottom">
										{!isProActive() && (<span className="theme-pro-tags single-pro">{lockpro}{` `}{getStrings('pro')}</span>)}
							...
							<button
								...
								onMouseEnter={() => handleMouseEnter('style-7')}
								onMouseLeave={handleMouseLeave}
							...
							>
								...
								<div className="text">
									<div className="top">
										<div className="label">
											<div className="radio-field"></div>
											<div className="label-title">{getStrings('dark-style-theme')}</div>
										</div>
									</div>
									<div className="bottom">
										{!isProActive() && (<span className="theme-pro-tags">{lockpro}{` `}{getStrings('pro')}</span>)}
							...
							{Object.keys(tableSettings?.table_settings?.import_styles_theme_colors || {})
								...
								.map((themeName, index) => (
									<button
										key={index}
										className={`single-theme new-custom-theme${tableSettings?.table_settings?.table_style === themeName ? ' active' : ''}`}
							...
							<button className="single-theme add-new-theme"
								onClick={() => handleCustomthememodal('swptls-new-theme')}
								onMouseEnter={() => handleMouseEnter('swptls-new-theme')}
								onMouseLeave={handleMouseLeave}
							...
							>
								...
								{isHovered === 'swptls-new-theme' && !isProActive() && (
									<div className='btn-pro-lock theme-lock-blur'>{lockBTN}</div>
								)}
					...
					<div className={`theme-customization-options-parent ${tableSettings
						?.table_settings
						?.import_styles ? 'active_sheetstyle' : 'disable_sheetstyle'
						}`}>
						...
						{!isProActive() && (<div className='btn-pro-lock theme-lock-blur'>{lockBTN}</div>)}
