										...
										<>
											...
											<div className="invalid-card has--limit-upgrade">
												...
												>
													...
													<span>The table is limited to 30 rows. <a className='upgrade-now-btn-txt' onClick={() => handleVisit()}>Upgrade to Pro</a> to show the full Google Sheet with awesome customizations</span>
												</label>
